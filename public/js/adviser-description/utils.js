...
function getAdviser() {
	...
	const route = `https://devdash.universopsiquico.com/api/advicer?id=${adviser}`;
	$.ajax({
		url: route,
		method: "GET",
		dataType: "JSON",
...
// function getAdviser() {
// 	return new Promise((resolve, reject) => {
// 	const route = `https://devdash.universopsiquico.com/api/advicer?id=${specialityId}`;
// 	$.ajax({
// 		url: route,
// 		method: "GET",
// 		dataType: "JSON",
...
export default async function main() {
	try {
		...
		if (!loadedOneTime) {
			...
			if (video_url != null) {
				$('#adviser-video').html(`<video src="https://universopsiquico.com/${video_url}" controls width="100%" height="auto"></video>`);
			}
