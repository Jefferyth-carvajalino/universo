...
@push('styles_header')
    <link rel="stylesheet" href="{{asset('libs/emojionearea/emojionearea.min.css')}}">
    <link rel="stylesheet" href="{{asset('css/dash-advicer/dshb-inbox-especialista.min.css')}}">
@endpush
@section('page')
Chat
@endsection
...
@endsection
@push('scripts_footer')
    @include('advicer.viewInbox.scripts')
@endpush
