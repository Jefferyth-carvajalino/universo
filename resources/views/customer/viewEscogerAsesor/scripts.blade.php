<script>
    ...
    async function filterAdvisers(searchWord) {
        ...
        let searchedAdvisers = advisers.filter(function({
            nickname
        }) {
    ...
    function adviserInFirstPosition(arrayToModify, adviserToChangeId) {
        ...
        const adviserToChange = advisers.find(({
            adviser_id
        }) => adviser_id === adviserToChangeId);

        if (adviserToChange) {
            const adviserToRemoveIndex = advisers.findIndex(({
                adviser_id
            }) => adviser_id === adviserToChangeId);
    ...
    $('#search-adviser-input').keyup(function() {
        $('#search-adviser-form').submit();
    });
