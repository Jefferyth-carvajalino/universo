...
<header>
	...
	<div class="brand-container">
		<a href="/"><img src="{{asset('img/commons/brand.svg')}}" alt=""></a>
	</div>
	...
	<div class="btn-login-container">
		{{-- <?php
            // echo (isset($_SESSION['id_user'])) ? '<a href="/log-in/" id="btn-login"><span><img src="/src/img/dashboard/i-perfil.svg" alt=""></span><span>' . $_SESSION['username'] . '</span></a>' : '<a href="/log-in/" id="btn-login"><span><img src="/src/img/dashboard/i-perfil.svg" alt=""></span><span>Iniciar Sesión</span></a>';
             ?> --}}
	</div>

	<div class="social-networks-container">
		<a href="https://www.facebook.com/Universo-Ps%C3%ADquico-104114208442533"><img src="{{asset('img/commons/h-fb.svg')}}" alt=""></a>

		<a href="https://www.instagram.com/somosuniversopsiquico/"><img src="{{asset('img/commons/h-ig.svg')}}" alt=""></a>
	</div>
</header>
