...
if (isset($_SESSION['id_user'])) {
	if ($_SESSION['kind_user'] == "adviser") {
		header('Location: /dashboard-especialista/perfil/');
	} else {
		header('Location: /dashboard-consultor/buscar-asesor/');
	}
}
?>
<!DOCTYPE html>
...
<head>
	...
	<meta name="google-signin-client_id" content="656862645876-r0706b932nskde2ibhmtjgrpalo52dj1.apps.googleusercontent.com">

	<title>UniversoPsiquico</title>

	<link rel="stylesheet" href="/src/css/log-in.min.css">
	...
	<!-- Event snippet for Registro Universo Psíquico. conversion page In your
...
<body>
	...
	<script src="/src/libs/sha256/sha256.min.js"></script>
	<script type="module" src="/src/js/login-script.js"></script>
</body>
