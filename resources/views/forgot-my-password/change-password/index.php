...
<head>
	...
	<link rel="stylesheet" href="/src/css/forgot-my-password.min.css">
...
<body>
					...
					<form>
						<div class="form-inputs-box">
							<div class="input-container">
								...
								<input type="password" id="new-password" placeholder="Nueva contraseña" autofocus="true">
							</div>
							...
							<div class="input-container">
								...
								<input type="password" id="repeat-password" placeholder="Repite la contraseña" autofocus="true">
							</div>
						</div>

						<div class="submit-container">
							<a href="#" id="update-password">Actualizar</a>
						</div>
					</form>
				</div>
			</div>
	...
	<script src="/src/js/change-password-script.js"></script>
</body>
