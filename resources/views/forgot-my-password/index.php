...
<body>
		...
		<section>
			<div id="card">
				<div>
					...
					<p>Te enviaremos un enlace a tu correo electrónico para recuperar tu contraseña.</p>
					...
					<form>
						<div class="form-inputs-box">
							<div class="input-container">
								...
								<input type="text" id="email" placeholder="Correo electrónico" autofocus="true">
							</div>
						</div>

						<div class="submit-container">
							<a href="#" id="send-link">Enviar</a>
						</div>
					</form>
				</div>
			</div>
	...
	<script src="/src/js/forgot-my-password-script.js"></script>
</body>
