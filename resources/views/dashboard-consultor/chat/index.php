...
<head>
	...
	<link rel="stylesheet" href="/src/css/dshb-chat-consultor.min.css">
...
<body>
	...
	<div class="popup" id="three-minutes-popup">
		<div class="popup-container">
			<button class="btn-close-popup" id="btn-close-popup-three-minutes">
			...
			<div class="popup-content">
				<a href="/log-in/">
					<img src="/src/img/three-minutes.jpg" alt="Tres minutos gratis" srcset="">
				</a>
			</div>
		</div>
	</div>
	...
	<script src="/src/js/dashboard-consultor/chat-script.js"></script>
</body>
