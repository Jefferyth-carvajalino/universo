...
@push('page_styles')
	{!!Html::style('css/log-in-advisers.css')!!}
@endpush
...
<main>
			...
			<div id="log-in-card">
				<div>
					<div>
						...
						<a href="#" class="lgntab-link active" data-tc="lgntab-i-2">
							Iniciar Sesión
						</a>
					</div>
					...
					<div>
						...
						<div class="lgntab-items-container">
							<div class="show-right" id="lgn-itabs-c">
    ...
    @push('page_scripts')
        <script src="{{asset('js/login-adviser-script.js')}}"></script>
    @endpush
@endsection